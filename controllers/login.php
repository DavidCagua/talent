    ...
    function authenticate(){
        if( $this->existPOST(['username', 'password']) ){
            ...
            if($username == '' || empty($username) || $password == '' || empty($password)){
                ...
                $this->redirect('', ['error' => ErrorsMessage::ERROR_LOGIN_AUTHENTICATE_EMPTY]);
                return;
            }
            ...
            if($user != NULL){
                ...
                $this->redirect('login', ['error' => ErrorsMessage::ERROR_LOGIN_AUTHENTICATE_DATA]);
                return;
            }
        }else{
            ...
            $this->redirect('', ['error' => ErrorsMessage::ERROR_LOGIN_AUTHENTICATE]);
        }
    }
