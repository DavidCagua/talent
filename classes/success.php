...
class SuccessMessage{
    ...
    {
        $this->successList = [
            SuccessMessage::SUCCESS_ADMIN_NEWCATEGORY => "Nueva categoría creada correctamente",
            SuccessMessage::SUCCESS_EXPENSES_DELETE => "Gasto eliminado correctamente",
            SuccessMessage::SUCCESS_EXPENSES_NEWEXPENSE => "Nuevo gasto registrado correctamente",
            SuccessMessage::SUCCESS_USER_UPDATEBUDGET => "Presupuesto actualizado correctamente",
            SuccessMessage::SUCCESS_USER_UPDATENAME => "Nombre actualizado correctamente",
            SuccessMessage::SUCCESS_USER_UPDATEPASSWORD => "Contraseña actualizado correctamente",
            SuccessMessage::SUCCESS_USER_UPDATEPHOTO => "Imagen de usuario actualizada correctamente",
